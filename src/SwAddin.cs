...
namespace SuplementoParaGerarPDFSolidWorks
{
    /// <summary>
    /// Summary description for SuplementoParaGerarPDFSolidWorks.
    /// </summary>
    [Guid("bfada14d-7f0a-4f7b-b78b-8968c009eea9"), ComVisible(true)]
    [SwAddin(
        Description = "SuplementoParaGerarPDFSolidWorks description",
        Title = "SuplementoParaGerarPDFSolidWorks",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            icons[0] = iBmp.CreateFileFromResourceBitmap("SuplementoParaGerarPDFSolidWorks.toolbar20x.png", thisAssembly);
            icons[1] = iBmp.CreateFileFromResourceBitmap("SuplementoParaGerarPDFSolidWorks.toolbar32x.png", thisAssembly);
            icons[2] = iBmp.CreateFileFromResourceBitmap("SuplementoParaGerarPDFSolidWorks.toolbar40x.png", thisAssembly);
            icons[3] = iBmp.CreateFileFromResourceBitmap("SuplementoParaGerarPDFSolidWorks.toolbar64x.png", thisAssembly);
            icons[4] = iBmp.CreateFileFromResourceBitmap("SuplementoParaGerarPDFSolidWorks.toolbar96x.png", thisAssembly);
            icons[5] = iBmp.CreateFileFromResourceBitmap("SuplementoParaGerarPDFSolidWorks.toolbar128x.png", thisAssembly);

            mainIcons[0] = iBmp.CreateFileFromResourceBitmap("SuplementoParaGerarPDFSolidWorks.mainicon_20.png", thisAssembly);
            mainIcons[1] = iBmp.CreateFileFromResourceBitmap("SuplementoParaGerarPDFSolidWorks.mainicon_32.png", thisAssembly);
            mainIcons[2] = iBmp.CreateFileFromResourceBitmap("SuplementoParaGerarPDFSolidWorks.mainicon_40.png", thisAssembly);
            mainIcons[3] = iBmp.CreateFileFromResourceBitmap("SuplementoParaGerarPDFSolidWorks.mainicon_64.png", thisAssembly);
            mainIcons[4] = iBmp.CreateFileFromResourceBitmap("SuplementoParaGerarPDFSolidWorks.mainicon_96.png", thisAssembly);
            mainIcons[5] = iBmp.CreateFileFromResourceBitmap("SuplementoParaGerarPDFSolidWorks.mainicon_128.png", thisAssembly);
